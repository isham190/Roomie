...
import com.ish.roomie.utils.Utils;
...
public class TagView extends RelativeLayout {
    ...
    private void drawTags() {
        ...
        for (Tag item : mTags) {
            ...
            // inflate tag layout
            final View tagLayout = (View) mInflater.inflate(R.layout.tagview_item, null);
            tagLayout.setId(listIndex);
//            tagLayout.setBackground(getSelector(tag));
            tagLayout.setBackgroundResource(R.drawable.tag_box_background);
            ...
            tagLayout.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mClickListener != null) {
                        tagLayout.setBackgroundResource(R.drawable.tag_box_selected_background);
...
//                tagParams.addRule(RelativeLayout.RIGHT_OF, indexBottom);
